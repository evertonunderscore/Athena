<?php 
        ...
        <footer id="saas_two_footer" class="saas_two_footer_section relative-position">
            <div class="s2-newslatter_section relative-position">
                <div class="container">
                    ...
                    <div class="newsletter_pattern_1"><img src="<?php echo $link; ?>/assets/img/saas-c/banner/nb.png" alt=""></div>
                    <div class="cloud_anim newsletter_pattern_2" style="background-image: url(<?php echo $link; ?>/assets/02/cloud-2.html);"></div>
                    <div class="cloud_anim newsletter_pattern_3" style="background-image: url(<?php echo $link; ?>/assets/02/cloud-5.html);"></div> 
                    <div class="newsletter_pattern_4 " style="background-image: url(<?php echo $link; ?>/assets/img/saas-c/banner/ns.png);"></div>
                    <div class="newsletter_pattern_5 " style="background-image: url(<?php echo $link; ?>/assets/img/saas-c/banner/ns2.png);"></div>
                </div>
            </div> 
                            ...
                            <div class="s2_footer_widget clearfix ul-li-block  saas2-headline">
                                <div class="s2_footer_about">
                                    <div class="s2-footer_logo">
                                        <img src="<?php echo $link; ?>/assets/img/saas-c/logo/f-logo.png" alt="">
                                    </div>
    ...
    <!-- End of footer section 
        ...
        <script src="<?php echo $link; ?>/assets/js/jquery.js"></script>
        <script src="<?php echo $link; ?>/assets/js/popper.min.js"></script>
        <script src="<?php echo $link; ?>/assets/js/bootstrap.min.js"></script>
        <script src="<?php echo $link; ?>/assets/js/wow.min.js"></script>
        <script src="<?php echo $link; ?>/assets/js/tilt.jquery.min.js"></script>
        <script src="<?php echo $link; ?>/assets/js/owl.js"></script>
        <script src="<?php echo $link; ?>/assets/js/aos.js"></script>
        <script src="<?php echo $link; ?>/assets/js/slick.js"></script>
        <script src="<?php echo $link; ?>/assets/js/jquery.barfiller.js"></script>
        <script src="<?php echo $link; ?>/assets/js/parallax-scroll.js"></script>
        <script src="<?php echo $link; ?>/assets/js/jquery.paroller.min.js"></script>
